...
public class RoleCtrlValidationsTest {
    ...
    public void validateWhenEmpty() throws Exception {
        final Role r = new Role("", "", Collections.EMPTY_SET);
        final String requestJson = mapper.writeValueAsString(r);
    ...
    public void validateWhenMax() throws Exception {
        ...
        final Role r = new Role(longText.toString(), longText.toString(), Collections.EMPTY_SET);
        final String requestJson = mapper.writeValueAsString(r);
    ...
    public void validatePageWhenPageDataRequestError() throws Exception {
        final PageDataRequest p = new PageDataRequest(null, null, null, Collections.EMPTY_LIST, null);
    ...
    public void validatePageWhenFilterRequestError() throws Exception {
        ...
        final PageDataRequest p = new PageDataRequest(-2, -1, "", null, filters);
        final String requestJson = mapper.writeValueAsString(p);
